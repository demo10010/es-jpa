 ...
 */
@Component
public class EsRepositoryBeanDefinitionRegistry implements BeanDefinitionRegistryPostProcessor, ResourceLoaderAware, ApplicationContextAware {

    private static final String ELASTICSEARCH_REPOSITORY_PACKAGE = "elasticsearch.repository.package";
...
//            Annotation[] declaredAnnotations = beanClazz.getDeclaredAnnotations();
            for (int i = 0; i < annotations.length; i++) {
                ...
                if (hasAnnotation) {
                    doPostProcessBeanDefinitionRegistry(registry, beanClazz);
                }
            }
        }
    }
    ...
    private void doPostProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry, Class<?> beanClazz) {
        ...
        definition.setBeanClass(EsRepositoryProxyFactoryBean.class);
